...
final class AppModel {
    ...
    static func preview() -> AppModel {
        let model = AppModel(engine: RepoEngine(persistence: RepoPersistence(directory: FileManager.default.temporaryDirectory.appendingPathComponent("fetchbar-preview"))), settings: AppSettings(defaults: UserDefaults(suiteName: "preview")!))
        return model
    }
}
