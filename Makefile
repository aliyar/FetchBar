...
generate:            ## Generate FetchBar.xcodeproj (+ Info.plist/entitlements) from project.yml
...
sparkle-key-export:  ## Export the Sparkle EdDSA private key: make sparkle-key-export FILE=~/Desktop/fetchbar-sparkle-key.txt
