<p align="center">
  <img src="docs/icon.png" width="128" height="128" alt="FetchBar icon">
</p>
...
<p align="center">
  <a href="https://fetchbar.greatpixels.com"><b>fetchbar.greatpixels.com</b></a>
</p>
...
<p align="center">
  <picture>
    ...
    <img src="docs/screenshots/hero-light.jpg" width="780" alt="FetchBar in the macOS menu bar: colored dots per repository and the panel listing incoming commits">
  </picture>
</p>
...
<table>
  ...
  <tr>
    <td><img src="docs/screenshots/panel-light.png" alt="The FetchBar panel in light appearance, with an expanded repository showing incoming commits and actions"></td>
...
<table>
  ...
  <tr>
    <td><img src="docs/screenshots/settings-light.png" alt="FetchBar settings in light appearance: check interval, launch at login, notifications, menu bar style with live preview"></td>
...
concurrently. Everything stays on your Mac: FetchBar has no backend, no telemetry and no accounts.
...
3. The app is not notarized, so macOS asks for one extra step on first launch:
   - **macOS 14:** right-click `FetchBar.app` → *Open* → *Open*.
   - **macOS 15 and later:** open it once (macOS refuses), then *System Settings → Privacy & Security → Open Anyway*.
   - Still blocked? `xattr -dr com.apple.quarantine /Applications/FetchBar.app`
...
`project.yml` is the source of truth; `FetchBar.xcodeproj` is generated and git-ignored.
